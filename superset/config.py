...
# SUPERSET_VERSION env var overrides (e.g. for dev/Docker: "0.0.89").
VERSION_STRING = (
    os.environ.get("SUPERSET_VERSION")
    or _try_json_readversion(VERSION_INFO_FILE)
    or _try_json_readversion(PACKAGE_JSON_FILE)
)
