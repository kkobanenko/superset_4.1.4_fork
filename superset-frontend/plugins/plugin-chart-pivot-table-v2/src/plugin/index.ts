...
> {
  ...
  constructor() {
    const metadata = new ChartMetadata({
      ...
      category: t('Table'),
      description: t(
        'Enhanced pivot table with advanced formatting options for each grouping field. Supports custom column widths, sorting, subtotals, value formatting (absolute/percentage/combined), font and background styling, and configurable totals. Version 0.0.45',
      ),
