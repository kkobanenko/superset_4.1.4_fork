...
export function getLabelFontSize(size: 'normal' | 'small' | 'micro'): number {
...
export type EchartsMixedTimeseriesFormData = QueryFormData & {
  ...
  stackedLabelPositionB: 'top' | 'middle';
  hideZeroValues: boolean;
  hideZeroValuesB: boolean;
  labelFontSize: 'normal' | 'small' | 'micro';
  labelFontSizeB: 'normal' | 'small' | 'micro';
  yAxisIndex?: number;
  yAxisIndexB?: number;
...
export const DEFAULT_FORM_DATA: EchartsMixedTimeseriesFormData = {
  ...
  stackedLabelPosition: 'top',
  stackedLabelPositionB: 'top',
  hideZeroValues: false,
  hideZeroValuesB: false,
  labelFontSize: 'normal',
  labelFontSizeB: 'normal',
  yAxisIndex: 0,
  yAxisIndexB: 0,
  groupby: [],
  groupbyB: [],
